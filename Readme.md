...
Закинуть по пути: C:\Program Files\Cisco Packet Tracer 8.2.1\languages

Далее в Options выбрать перевод и перезапустить СРТ

Частичный перевод для CPT 8.2.1 (Переведено премерно 70% от всех функций.)
...
ps. вроде как работает даже на версии 9.0.0 но точную работоспособность не гарантирую
